package de.bsommerfeld.neverlose.plan;
...
/**
 * Represents a training plan that consists of a collection of training units. A training plan is
 * identified by a unique ID and contains a name and description.
 */
