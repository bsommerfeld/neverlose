 ...
 * This class encapsulates all layout-related constants to maintain consistency
 * across the PDF generation process.
 */
public class PdfLayout {
  ...
  // Indentation
  public static final float INDENT_UNIT_LEVEL = Theme.Layout.INDENT_UNIT_LEVEL;
  public static final float INDENT_EXERCISE_CONTAINER = Theme.Layout.INDENT_EXERCISE_CONTAINER;
  public static final float INDENT_EXERCISE_INTERNAL = Theme.Layout.INDENT_EXERCISE_INTERNAL;
  ...
  public static final float SPACING_BETWEEN_UNITS = Theme.Layout.SPACING_BETWEEN_UNITS;
  ...
  public static final float SPACING_BEFORE_EXERCISES = Theme.Layout.SPACING_BEFORE_EXERCISES;
  public static final float SPACING_BETWEEN_EXERCISES = Theme.Layout.SPACING_BETWEEN_EXERCISES;
