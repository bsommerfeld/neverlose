 ...
 */
@View
public class ExerciseTemplateBrowserController extends AbstractBrowserController<ExerciseSummary, TrainingExercise, ExerciseCardController> {
    ...
    @Override
    protected void setupCardController(ExerciseCardController cardController, ExerciseSummary template) {
