...
public class TopBarController {
  ...
  /**
   * Registers components to be displayed in the TopBar.
   * These components will be added to the dynamic components container.
   *
  ...
  /**
   * Registers components to be displayed in the TopBar with CENTER alignment.
  ...
  /**
   * Unregisters all components from the TopBar.
   * This removes all components from the dynamic components container.
   */
  ...
  /**
   * Unregisters specific components from the TopBar.
   * This removes the specified components from the dynamic components container.
   *
