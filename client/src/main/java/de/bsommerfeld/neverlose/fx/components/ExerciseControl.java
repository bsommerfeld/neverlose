...
/**
 * A custom JavaFX control that represents a TrainingExercise in the WYSIWYG editor. This control allows for direct
 * editing of the TrainingExercise's properties.
 */
public class ExerciseControl extends VBox {
    ...
    public ExerciseControl(
        ...
        grid.getStyleClass().add("exercise-grid");
    ...
    /**
     * Handles the action of saving the exercise as a template. Checks for existing templates with the same name and
     * asks for confirmation before overwriting. Saves the exercise to the storage service and shows a confirmation
     * message.
     */
    ...
    /**
     * Handles the action of removing the exercise. If a callback is set, it will be called with the exercise after
     * confirmation.
     */
    ...
    /**
     * Toggles the visibility of the action buttons when the "More" button is clicked. This is primarily for touch
    ...
    /**
     * Initializes the event handlers for mouse events but does not attach them. This allows for on-demand activation of
     * listeners.
     */
    ...
    /**
     * Sets up a listener to monitor visibility changes and activate/deactivate mouse listeners accordingly.
     */
    ...
    /**
     * Cleans up all listeners to prevent memory leaks. This should be called when the control is no longer needed.
     */
    public void cleanup() {
    ...
    /**
     * Applies caching hints to improve layout performance. This reduces the need for frequent layout calculations.
     */
