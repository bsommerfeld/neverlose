...
public class TrainingPlanEditorMetaController {
  ...
  @FXML private TrainingPlanEditorFormController editorFormController;
  @FXML private TrainingPlanEditorPreviewController editorPreviewController;
  ...
  /**
   * Loads a new TrainingPlan into the editor. This is now the primary entry point for loading data.
  ...
  /**
   * Call this method when the entire editor view is being closed or disposed of. It delegates
   * cleanup tasks to the sub-controllers.
   */
  public void cleanup() {
